 ...
 */
public class BasicShareholder2 extends JamelObject implements Agent, Shareholder {
	...
	static public Consumer<? super Agent> getAction(final String phaseName) {
		...
		case "consumption":
			action = (agent) -> {
				((BasicShareholder2) agent).consumption();
			};
			break;
		default:
	 ...
	 */
	public BasicShareholder2(final Sector sector, final int id) {
