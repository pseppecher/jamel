...
public interface MacroDatabase {
	...
	/**
	 * Returns an {@link Expression} the value of which will be a statistical function of this dataset.
	 * @param query a string that contains the definition of the function to be returned.
