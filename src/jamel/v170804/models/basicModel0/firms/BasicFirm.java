...
import jamel.v170804.models.basicModel0.households.Shareholder;
...
public class BasicFirm extends JamelObject implements Agent, Firm, Employer, Supplier {
	...
	public BasicFirm(final Sector sector, final int id) {
		...
		// THe string "Banks" should be a parameter.
	...
	private void production() {
		...
		if (this.factory.getInventories().getVolume() > 0) {
			...
			this.dataset.put("supplyValue", markup * this.factory.getInventories().getValue());
	...
	private void updateMarkup() {
		// TODO 0.03, 250, should be parameters.
