 ...
 */
public class HtmlPanel2bak extends JScrollPane implements AdjustmentListener, Updatable {
	 ...
	 *            the expression factory.
	 */
	public HtmlPanel2bak(final Element elem, final Gui gui, final ExpressionFactory expressionFactory) {
		super();
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				if (adjustScrollBar) {
					...
					scrollBar.removeAdjustmentListener(HtmlPanel2bak.this);
					value = maximum - extent;
					scrollBar.setValue(value);
					scrollBar.addAdjustmentListener(HtmlPanel2bak.this);
				}
	...
	public void update() {
		...
		if (!this.text.equals(newText)) {
			...
			SwingUtilities.invokeLater(new Runnable() {
				@Override
				public void run() {
					HtmlPanel2bak.this.jEditorPane.setText(newText);
					HtmlPanel2bak.this.revalidate();
					HtmlPanel2bak.this.repaint();
				}
			});
		}
	}
