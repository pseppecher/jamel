...
public class LaborMarket extends ChartPanel {
	...
	private static JFreeChart newChart() {
		TimeChart chart = new TimeChart(
				...
				Circuit.getCircuit().getTimeSeries().get(Labels.JOB_OFFERS)				
		);
		chart.setXYDifferenceRenderer(0, JamelColor.ULTRA_TRANSPARENT_RED, JamelColor.ULTRA_TRANSPARENT_BLUE);
