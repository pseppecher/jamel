...
public class UnemploymentDuration extends ChartPanel {
	...
	private static JFreeChart newChart() {
		final TimeChart chart = new TimeChart("Unemployment Duration", "Months",
				Circuit.getCircuit().getTimeSeries().get(Labels.UNEMPLOYMENT_DURATION)
				);
		return chart;
	}
