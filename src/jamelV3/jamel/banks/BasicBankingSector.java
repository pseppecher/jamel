...
import jamelV3.jamel.util.RepresentativeAgentDataset;
...
public class BasicBankingSector implements Sector, Corporation, BankingSector {
	...
	/*
	 * TODO méthode devenue inutile. 
	 * A détruire dès que possible (dès que getNewAccount() aura été implémentée).
	 */
	@SuppressWarnings("javadoc")
